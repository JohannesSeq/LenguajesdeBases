<?php 
    ...
    if (isset($_POST['id'])) {
        ...
        $query = "BEGIN 
                    :resultado := EJECUTAR_BORRADO_DEPARTAMENTO(:P_ID_DEPARTAMENTO, :P_TIPO, :P_COMENTARIO); 
                  END;";

        $stmt = oci_parse($conn, $query);
        
        oci_bind_by_name($stmt, ":P_ID_DEPARTAMENTO", $id);
        ...
        echo json_encode([
            ...
            'mensaje' => $resultado === 'TIPO_INVALIDO' 
                ...
                : 'DEPARTAMENTO eliminado correctamente (' . $resultado . ')'
        ]);
