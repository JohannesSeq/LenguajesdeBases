<?php 
    ...
    if (isset($_POST['id'])) {
        ...
        $query = "BEGIN 
                    :resultado := EJECUTAR_BORRADO_ROL_PERSONA(:P_ID_ROL_PERSONA, :P_TIPO, :P_COMENTARIO); 
                  END;";

        $stmt = oci_parse($conn, $query);
        
        oci_bind_by_name($stmt, ":P_ID_ROL_PERSONA", $id);
        ...
        echo json_encode([
            ...
            'mensaje' => $resultado === 'TIPO_INVALIDO' 
                ...
                : 'Rol eliminado correctamente (' . $resultado . ')'
        ]);
