            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modificarprovinciamodalLabel">Modificar Pedido</h5>
                ...
                <div class="modal-body">
                    <form id="Agregar_Provincia_Form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre_provincia" placeholder="Ingresa el nombre del provincia." required>
                        </div>
