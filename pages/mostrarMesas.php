...
<div class="modal fade" id="modalAgregarMesa" tabindex="-1" role="dialog">
    <div class="modal-dialog"><div class="modal-content">
        <div class="modal-header"><h5 class="modal-title">Agregar Mesa</h5></div>
        <div class="modal-body">
            <form id="Agregar_Mesa_Form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="id_estado" required>
                </div>
...
<div class="modal fade" id="modalModificarMesa" tabindex="-1" role="dialog">
    <div class="modal-dialog"><div class="modal-content">
        <div class="modal-header"><h5 class="modal-title">Modificar Mesa</h5></div>
        <div class="modal-body">
            <form id="Modificar_Mesa_Form">
                <input type="hidden" id="mesa_id_modificar">
                <div class="form-group">
                    <label for="mod_id_horario">ID Horario</label>
                    <input type="number" class="form-control" id="mod_id_horario" required>
                </div>
                <div class="form-group">
                    <label for="mod_id_estado">ID Estado</label>
                    <input type="text" class="form-control" id="mod_id_estado" required>
                </div>
