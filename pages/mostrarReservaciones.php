...
<body onload="Check_Permissions('Empleado'); listarreservaciones(); ">
    ...
    <div class="container-fluid mt-3">
        <div class="jumbotron">
            ...
            <hr class="my-4">
            <a class="button-62" href="#" data-toggle="modal" data-target="#modalAgregarReservacion">Agregar nueva
                reservación</a>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="FormularioEditarReservacion">
                        ...
                        <div class="form-group">
                            <label for="editar_horario">Horario disponible</label>
                            <select class="form-control" id="editar_horario" required></select>
                        </div>

                        <div class="form-group">
                            <label for="editar_mesa">Mesa disponible</label>
