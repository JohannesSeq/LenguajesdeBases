...
--Creación de la tabla de empleados con ID autoincrementable
...
--- Configuracion de la particion de la tabla estados
ALTER TABLE ESTADOS
MODIFY PARTITION BY LIST(ESTADO)(
    PARTITION P_ACTIVOS VALUES('Activo'),
    PARTITION P_INACTIVOS VALUES('Inactivo')
);

-- Permiimos el mover los datos entre particiones ya que la tabla 
ALTER TABLE ESTADOS ENABLE ROW MOVEMENT;

ANALYZE TABLE ESTADOS COMPUTE STATISTICS;
 
EXEC RESTAURAR('ST_41_PROVINCIA');