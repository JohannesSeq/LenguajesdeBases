...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        P_RESULTADO := 'NO_EXISTE_DISTRITO';
END;
/
...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        P_RESULTADO := 'NO_EXISTE_PROVINCIA';
END;
/

-------------- Procedimiento para eliminar un rol ----------------------

CREATE OR REPLACE PROCEDURE ELIMINAR_ROL_PERSONA(
...
BEGIN
    ...
    FROM ROL_PERSONA
    WHERE ID_ROL_PERSONA = P_ID_ROL_PERSONA;
    DELETE FROM ROL_PERSONA WHERE ID_ROL_PERSONA = P_ID_ROL_PERSONA;
    DELETE FROM ESTADOS WHERE ID_ESTADO = V_ID_ESTADO;
    COMMIT;
...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        P_RESULTADO := 'NO_EXISTE_ROL_PERSONA';
END;
/