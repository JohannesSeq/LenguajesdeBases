...
CREATE OR REPLACE PACKAGE BODY PKG_FACTURAS AS
    ...
    BEGIN
        ...
        INSERT INTO FACTURAS(
            CEDULA_CLIENTE, ID_PEDIDO, ID_METODO, MONTO_TOTAL, 
            NOMBRE_CLIENTE, VUELTO, DESCUENTO, IVA
        )
        VALUES (
            P_CEDULA_CLIENTE, P_ID_PEDIDO, P_ID_METODO, P_MONTO_TOTAL,
            P_NOMBRE_CLIENTE, P_VUELTO, P_DESCUENTO, P_IVA
        )
        RETURNING ID_FACTURA INTO V_ID_FACTURA;

        -- Auditoría: Crear estado en tabla ESTADOS
        V_ESTADO_ID := CREAR_ENTRADA_ESTADO(TO_CHAR(V_ID_FACTURA), 'FACTURAS', P_COMENTARIO);
        UPDATE FACTURAS SET ID_ESTADO = V_ESTADO_ID WHERE ID_FACTURA = V_ID_FACTURA;
...
BEGIN
    ...
    -- Eliminar los platillos que fueron facturados
    DELETE FROM LISTA_PLATILLOS WHERE ID_FACTURA = P_ID_FACTURA;
