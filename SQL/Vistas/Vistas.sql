...
CREATE OR REPLACE VIEW VISTA_PEDIDOS_PLATILLOS
AS
    SELECT 
...
SELECT 
    ...
    E.SALARIO,
    E.ID_ESTADO,
    EST.ESTADO AS ESTADO_REGISTRO
FROM 
    EMPLEADOS E
    JOIN PERSONAS P ON E.CEDULA = P.CEDULA
    JOIN ROL_PERSONA RP ON P.ID_ROL_PERSONA = RP.ID_ROL_PERSONA
...
SELECT 
    ...
    M.NOMBRE_MESA AS MESA,
    H.HORA_EXACTA AS HORARIO,
    R.CONFIRMACION
FROM RESERVACIONES R
JOIN PERSONAS P ON R.CEDULA_CLIENTE = P.CEDULA
JOIN MESAS M ON R.MESA = M.ID_MESA
JOIN HORARIOS_MESA H ON R.ID_HORARIO = H.ID_HORARIO;
...
SELECT 
    ...
    ES.ESTADO
FROM FACTURAS F
JOIN PERSONAS P ON F.CEDULA_CLIENTE = P.CEDULA
...
DECLARE 
    V_TEST VARCHAR(250);
BEGIN
    V_TEST := EJECUTAR_BORRADO_EMPLEADO(81, 'logico', 'Se fue');
