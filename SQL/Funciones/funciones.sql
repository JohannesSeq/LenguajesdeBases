...
BEGIN
    IF LOWER(P_TIPO) = 'logico' THEN
        BORRADO_LOGICO('RESERVACIONES', P_ID_DISTRITO, P_COMENTARIO);
        RETURN 'BORRADO_LOGICO';
    ELSIF LOWER(P_TIPO) = 'fisico' THEN
...
BEGIN
    IF LOWER(P_TIPO) = 'logico' THEN
        BORRADO_LOGICO('RESERVACIONES', P_ID_CANTON, P_COMENTARIO);
        RETURN 'BORRADO_LOGICO';
    ELSIF LOWER(P_TIPO) = 'fisico' THEN
...
BEGIN
    IF LOWER(P_TIPO) = 'logico' THEN
        BORRADO_LOGICO('RESERVACIONES', P_ID_PROVINCIA, P_COMENTARIO);
        RETURN 'BORRADO_LOGICO';
    ELSIF LOWER(P_TIPO) = 'fisico' THEN
