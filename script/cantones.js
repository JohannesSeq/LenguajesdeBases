$(document).ready(function(){
    ...
    $('#Agregar_Canton_Form').submit(function(e){
        ...
        $.ajax({
            url: '../php/agregarCanton_Process.php',
            method: 'POST',
    ...
    $(document).on('click', '.btn-modify', function () {
        ...
        $.ajax({
            url: '../PHP/listadocantonindividual_process.php', // URL del archivo PHP que devolverá los detalles del canton
    ...
    $('#ModificarCantonForm').on('submit', function (e) {
        ...
        $.ajax({
            url: '../PHP/modificarcanton_process.php', // URL del archivo PHP que procesará la solicitud de actualización
    ...
    $(document).on('click', '.btn-delete', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: '../PHP/eliminarcanton_process.php', // URL del archivo PHP que procesará la eliminación
...
function listadocantones() {
    $.ajax({
        url: '../PHP/listarcantones_process.php', // URL del archivo PHP que devolverá la lista de cantones
        method: 'GET', // Método HTTP para solicitar los datos
